...
try:
    ...
    while True:
        ...
        device.get_node("player-01").get_property("nickname").value = "Jose"
        time.sleep(5)
        device.update_score("0 - 1")
        device.get_node("player-01").get_property("nickname").value = "Lucien"
        time.sleep(5)
        device.update_score("1 - 0")
        device.get_node("player-01").get_property("nickname").value = "Marcel"
        time.sleep(5)
except (KeyboardInterrupt, SystemExit):
    print("Quitting.")  